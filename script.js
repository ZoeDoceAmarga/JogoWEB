function start() {
	...
	function colisao() {
		...
		if (colisao3.length > 0) {
			...
			velocidade = velocidade + 0.3; //aumentar a velocidade do inimigo1 com o tempo
			pontos = pontos + 100;
			inimigo1X = parseInt($("#inimigo1").css("left"));
			inimigo1Y = parseInt($("#inimigo1").css("top"));
	...
	function gameOver() {
		...
		$("#fim").html("<h1> Game Over </h1><p> Sua pontuação foi: " + pontos + "</p>" + "<div id='reinicia' onClick=reiniciaJogo()> <button>REINICIAR JOGO</button> </div>");
